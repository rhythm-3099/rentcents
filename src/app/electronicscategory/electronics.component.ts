...
import { Electronics_category_service } from '../services/electronics_category.service';
...
export class ElectronicsComponent implements OnInit, OnDestroy{
  ...
  constructor(public postsService: Electronics_category_service,private router: Router,private authService: AuthService) {
  ...
  ngOnInit() {
    ...
    this.postsService.getElectronicsPosts();
  ...
  //   this.postsService.getElectronicsPosts(this.postsPerPage,this.currentPage);
  // }
