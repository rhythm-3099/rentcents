...
import { Others_category_service } from '../services/others_category.service';
...
export class OthersComponent implements OnInit, OnDestroy{
  ...
  constructor(public postsService: Others_category_service,private router: Router,private authService: AuthService) {
