...
import { Educational_category_service } from '../services/educational_category.service';
...
export class EducationalComponent implements OnInit, OnDestroy{
  ...
  constructor(public postsService: Educational_category_service,private router: Router,private authService: AuthService) {
  ...
  ngOnInit() {
    ...
    this.postsService.getEducationalPosts();
  ...
  //   this.postsService.getEducationalPosts(this.postsPerPage,this.currentPage);
  // }
